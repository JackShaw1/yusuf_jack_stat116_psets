...
```
As we can see, as time progresses the Dash diet group curve is consistently above the other curve, suggesting they do have a higher probability of survivial. This difference is more pronounced towards the end. 
...
plot(dash_curve, col = "blue", lty = 1, xlab = "Time", ylab = "Survival Probability", 
     main = "Survival Curves for Prototypical Subjects")
lines(nodash_curve, col = "red", lty = 2)
